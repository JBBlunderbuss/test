    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">reactgenerator</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/cards">
            <ListItem button key="Card">
              ...
              <ListItemText className="menu-text" primary="Card" />
            </ListItem>
          </Link>{" "}            
           <Link to="/decks">
            <ListItem button key="Deck">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Deck" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
